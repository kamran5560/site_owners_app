            ...
            child: Column(
              children: [
                Container(
                  ...
                  padding:
                      EdgeInsets.only(top: 22, bottom: 32, left: 20, right: 20),
                  child: Row(
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Business_Card_3("Business", "Status",
                              "Business Running", context),
                          SizedBox(width: 24),
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Business_Card_4("Online Users v1", "Monthly views",
                              "315", context),
                          SizedBox(width: 24),
